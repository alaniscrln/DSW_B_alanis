<?php
    ...
    class ModeloBase{
        ...
        public function actualizar($id, $dato, $valor){
            $sql = "UPDATE " . $this->tabla . " SET $dato = '$valor' WHERE $this->clavePrimaria = '$id'";
        ...
        public function buscar($columna, $id){
            $sql = "SELECT * FROM " . $this->tabla . " WHERE $columna = '$id'";
            $resultado = $this->ejecutarSQL($sql);
            return $resultado;
        }

        public function contar(){
            $sql = "SELECT COUNT($this->clavePrimaria) FROM $this->tabla";
            $resultado = $this->ejecutarSQL($sql);
            return $resultado;
        }
