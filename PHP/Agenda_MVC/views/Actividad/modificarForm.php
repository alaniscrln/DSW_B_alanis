	...
	<div class="container text-center">
        ...
        <div class="col-4 offset-4 bg-light" >
            ...
            <form action="./../../controllers/PrincipalController.php" method="POST">
                <input type="hidden" name="tipo" value='modificarActividad' >
                <div class="form-group text-left">
                    <label for="id">Título (ID)</label>
                    <input type="text" class="form-control" id="id" name="id" placeholder="Título de la actividad a modificar">
                </div>
                <div class="form-group text-left">
                    <select class="custom-select form-control" name="select">
                        <option value="idContacto" selected>Cambiar ID del contacto</option>
                        <option value="hora">Cambiar hora</option>
                        <option value="fecha">Cambiar fecha</option>
                        <option value="lugar">Cambiar lugar</option>
                        <option value="actividad">Cambiar actividad</option>
                    </select>
