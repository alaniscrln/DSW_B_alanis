	...
	<div class="container text-center">
        ...
        <div class="col-4 offset-4 bg-light" >
            ...
            <form action="./../../controllers/PrincipalController.php" method="POST">
                <input type="hidden" name="tipo" value='insertarActividad' >
                ...
                <div class="form-group text-left">
                    ...
                    <input type="text" class="form-control" id="idContacto" name="idContacto">
                </div>
                ...
                <div class="form-group text-left">
                    ...
                    <input type="text" class="form-control" id="fecha" name="fecha" placeholder="formato dd/mm">
                </div>
                <div class="form-group text-left">
