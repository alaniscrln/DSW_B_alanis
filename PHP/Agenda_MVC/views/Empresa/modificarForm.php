	...
	<div class="container text-center">
        ...
        <div class="col-4 offset-4 bg-light" >
            ...
            <form action="./../../controllers/PrincipalController.php" method="POST">
                <input type="hidden" name="tipo" value="modificarEmpresa">
                <div class="form-group text-left">
                    <label for="id">CIAL</label>
                    <input type="text" class="form-control" id="id" name="id" placeholder="CIAL de la persona a modificar">
                </div>
                <div class="form-group text-left">
                    <select class="custom-select form-control" name="select">
                        ...
                        <option value="web">Cambiar página web</option>
                    </select>
