	...
	<div class="container text-center">
        ...
        <div class="col-4 offset-4 bg-light" >
            ...
            <form action="./../../controllers/PrincipalController.php" method="POST">
                <input type="hidden" name="tipo" value="modificarPersona">
                <div class="form-group text-left">
                    <label for="id">DNI</label>
                    <input type="text" class="form-control" id="id" name="id" placeholder="DNI de la persona a modificar">
                </div>
                <div class="form-group text-left">
                    <select class="custom-select form-control" name="select">
                        <option value="nombre" selected>Cambiar nombre</option>
                        <option value="telefono">Cambiar teléfono</option>
                        <option value="cumpleanos">Cambiar fecha de cumpleaños</option>
                    </select>
