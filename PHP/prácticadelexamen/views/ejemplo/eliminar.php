...
<div class="container text-center">
    ...
    <div class="col-4 offset-4 bg-light" >
            ...
            <h2>ELIMINAR</h2>
            <hr>
            <form action="#####/PrincipalController.php" method="GET">
                <input type="hidden" name="tipo" value="eliminar____________">
                <div class="form-group text-left">
                    <label for="id">ID:</label>
                    <input type="text" class="form-control" id="id" name="id" placeholder="________">
                </div>
                <hr>
