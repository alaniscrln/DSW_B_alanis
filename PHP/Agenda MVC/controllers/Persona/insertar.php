...
<body>
    ...
    <?php
        if (isset($_REQUEST['dni']) && isset($_REQUEST['nombre']) && isset($_REQUEST['telefono']) && isset($_REQUEST['cumpleanos']) ) {
            require './../../models/bbdd/crear_conexion.php';
            $dni =  $_POST['dni'];
            $nombre =  $_POST['nombre'];
            $telefono =  $_POST['telefono'];
            $cumpleanos =  $_POST['cumpleanos'];
            
            $sql = "INSERT INTO personas (dni, nombre, telefono, cumpleanos) VALUES ('$dni', '$nombre', '$telefono', '$cumpleanos')";

            if(mysqli_query($conn, $sql)){
                echo "<br><h1><center><br><br>" . $lang["bien_insertado"] . "<br></center></h1>";
            } else{
                echo "<br><h1 class='text-danger'><center>" . $lang["mal_insertado"] . "</center></h1>";
